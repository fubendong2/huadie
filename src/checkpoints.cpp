...
{    
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        (    0,     uint256("0x048b7369f55ed79ee5221b888e5eb6255fcaa5a4d13da71ed40f74cf50587eba"))
        ;
    static const CCheckpointData data = {
        &mapCheckpoints,
        1395580713, // * UNIX timestamp of last checkpoint block
        132779,     // * total number of transactions between genesis and last checkpoint
